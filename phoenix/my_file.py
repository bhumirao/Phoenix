...
def uploadImage():
  ...
  # Set the asset's public ID and allow overwriting the asset with new version
    ...
    cloudinary.uploader.upload("/home/bhumika/Documents/djEnv/phoenix/static/images/mainimg.jpg",
                               public_id="mainimg", use_filename=True, unique_filename=False, overwrite=True)
    srcURL = cloudinary.CloudinaryImage("mainimg").build_url()
...
def getAssetInfo():
  ...
  # Get image details and save it in the variable 'image_info'.
    image_info = cloudinary.api.resource("mainimg")
...
def createImageTag():
    ...
    image_tag=cloudinary.CloudinaryImage("mainimg").image()
